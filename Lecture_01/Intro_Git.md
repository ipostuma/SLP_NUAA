...
To gain deeper working knowledge about git and github, please refer to [this](https://docs.github.com/en/get-started/using-git/about-git) extended description.
